...
KANBAN_GUIDANCE = (
    ...
    "6. **Respect task-routing authority.** If `kanban_create` is available "
    "and your configured profile owns orchestration, create a bounded child "
    "task instead of scope-creeping. Otherwise, record the follow-up candidate "
    "or blocker in your structured handoff for the configured orchestrator; "
    "never manufacture an ad-hoc retry chain.\n"
    ...
    "## Orchestrator mode\n"
    "\n"
    "If your configured profile owns task routing and this task is itself a "
    "decomposition task (e.g. a planner profile given "
    ...
    "- Do not assign follow-up work to yourself. The configured orchestrator "
    "assigns it to the right specialist profile.\n"
